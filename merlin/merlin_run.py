...
if __name__ == "__main__":
    ...
    class topoDragonFly(Topo):
        ...
        def prepParams(self):
            ...
            #Fulya: set global link arrangement to "default" if not defined yet
            if "glb_link_arr" not in _params:
                _params["glb_link_arr"] = "default"
        ...
        def build(self):
            ...
            if _params["glb_link_arr"] == "default":
                print "Using default arrangement for dragonfly..."
                # GROUPS
            ...
            #Fulya: added absolute, relative, and circulant arrangements
            elif _params["glb_link_arr"] == "absolute":
                print "Using absolute arrangement for dragonfly..."
            ...
            elif _params["glb_link_arr"] == "relative":
                print "Using relative arrangement for dragonfly..."
                # GROUPS
                for g in xrange(_params["dragonfly:num_groups"]):
                    tgt_grp = 0
                    vport = 0 # virtual port of the virtual switch. k = {0,...,(num_groups-2)} in the paper.
            ...
            elif _params["glb_link_arr"] == "circulant-based":
                print "Using circulant-based arrangement for dragonfly..."
                ...
                for g in xrange(_params["dragonfly:num_groups"]):
                    ...
                    for r in xrange(_params["dragonfly:routers_per_group"]):
                        ...
                        for p in xrange(_params["dragonfly:intergroup_per_router"]):
                            ...
                            #print "p(%d)g(%d)->p(%d)g(%d)" %(vport, g, tgt_vport, tgt_grp)
                            #print "link name:g%dg%d:vp%dvp%d"%(src_g, dst_g, src_p, dst_p)
                            #print "g%dvp%d:g%dvp%d\tlink:g%dg%d:vp%dvp%d"%(g, vport, tgt_grp, tgt_vport, src_g, dst_g, src_p, dst_p)
                            port = port +1
                            vport = vport +1
                ...
                print "Error: Unknown dragonfly global link arrangement! (default | absolute | relative | circulant-based)"
                sys.exit(1)
            #end->Fulya
    ...
    #_params["glb_link_arr"] = "default"    
    #_params["glb_link_arr"] = "absolute"
    #_params["glb_link_arr"] = "relative"
    _params["glb_link_arr"] = "circulant-based"
